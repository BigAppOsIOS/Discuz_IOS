...
安装步骤参考 [Bigapp安装方法](http://www.bigappos，org)
...
当然，如果您是一名开发者可以加入我们一起把这项伟大的任务协作得更完美  （andriod ios php）

If you are a developer，you can join us （andriod ／ios ／php）

our qq Group number ：563342726
